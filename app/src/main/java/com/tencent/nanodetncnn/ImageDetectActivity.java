...
public class ImageDetectActivity extends Activity {
    private final String TAG = "ImageDetectActivity";
    ...
    private void initUI() {
        ...
        defaultPhoto.setOnClickListener(v->{
            String defaultPicName = "cigar.jpg";
            bitmap = getAssetsBitmap(ImageDetectActivity.this,defaultPicName);
            Log.d(TAG, "defaultPhoto: "+defaultPicName);
        ...
        buttonDetect.setOnClickListener(arg0 -> {
            ...
            yourSelectedImage = nanodetncnn.detectImage(getAssets(), yourSelectedImage,0);
        ...
        buttonDetectGPU.setOnClickListener(arg0 -> {
            if (yourSelectedImage == null)
                return;
            yourSelectedImage = nanodetncnn.detectImage(getAssets(), yourSelectedImage,1);
